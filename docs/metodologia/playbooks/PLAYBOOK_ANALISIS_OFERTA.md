...
`TEMPLATE_ANALISIS_OFERTA.md` es el **contrato operativo de materialización**.
...
El artefacto final seguirá la estructura definida por `TEMPLATE_ANALISIS_OFERTA.md` y resumida en la sección 8.
...
La materialización concreta se rige por `TEMPLATE_ANALISIS_OFERTA.md`.
...
Además del control anterior, la ejecución debe superar el checklist incluido en `TEMPLATE_ANALISIS_OFERTA.md`.
