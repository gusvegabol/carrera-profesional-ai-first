...
* guion, contenido, composición, revisión y veredicto final de la carta cuando la candidatura la requiera;
...
La aprobación de este gate valida únicamente el CV; la candidatura continúa con
la rama de carta si esta es requerida.

### 11.5 Cierre documental de la candidatura

Cuando el CV final esté aprobado y la carta final esté aprobada cuando la
candidatura la requiera, registrar:
...
Esta es la salida de la arquitectura actual de generación documental. No
requiere artefactos ni gates de presentación externa.

### 11.6 Presentación externa futura

La presentación en Indeed, LinkedIn, Lidl, Mercadona u otros portales queda
fuera de este playbook. Las credenciales, formularios, consentimientos y
envíos los gestiona la persona responsable bajo un contrato futuro específico.
La existencia de documentos completos nunca cambia automáticamente
`presentada`.

### 11.7 Después de una presentación externa real
...
La estructura concreta se materializa mediante `TEMPLATE_CANDIDATURA.md`.
