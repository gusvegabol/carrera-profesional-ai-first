...
Reducir el inicio de una sesión Work dedicada a la búsqueda de empleo a una invocación explícita y breve: `$iniciar-busqueda-empleo`.
...
1. Skill local: `.codex/skills/iniciar-busqueda-empleo/SKILL.md`.
   - Se activa únicamente cuando el usuario invoca `$iniciar-busqueda-empleo`.
...
1. El usuario abre una sesión Work vacía e invoca `$iniciar-busqueda-empleo`.
...
- En una sesión Work vacía, `$iniciar-busqueda-empleo` permite comenzar sin pegar el prompt largo de rehidratación.
