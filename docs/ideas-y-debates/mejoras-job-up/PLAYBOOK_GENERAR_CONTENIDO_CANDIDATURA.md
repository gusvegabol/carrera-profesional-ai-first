...
template: TEMPLATE_DATOS_GENERACION_CV_v1_FINAL.json
...
```text
TEMPLATE_DATOS_GENERACION_CV_v1_FINAL.json
```
...
schema_version: 1.2
template_id: TEMPLATE_DATOS_GENERACION_CV_v1.json
template_version: 1.2
```

La referencia normativa es el archivo literal
`TEMPLATE_DATOS_GENERACION_CV_v1_FINAL.json`. El identificador interno del
template permanece `TEMPLATE_DATOS_GENERACION_CV_v1.json` por compatibilidad
