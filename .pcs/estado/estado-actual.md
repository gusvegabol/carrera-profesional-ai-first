...
Job-up mantiene actualmente doce candidaturas registradas: dos rechazadas (`CAND-2026-001` y `CAND-2026-009`), cuatro enviadas mediante InfoJobs (`CAND-2026-002` a `CAND-2026-005`), dos candidaturas pendientes de aprobación (`CAND-2026-006` y `CAND-2026-012`), una candidatura detenida por cierre de oferta (`CAND-2026-011`) y tres candidaturas enviadas (`CAND-2026-007`, `CAND-2026-008` y `CAND-2026-010`). CAND-2026-011 tiene ya CV, carta y veredicto generados tras la autorización limitada de nombre, primer apellido, teléfono y correo; la empresa ha comunicado el cierre de la oferta, aunque Indeed aún la muestra abierta; no ha sido presentada. CAND-2026-012 tiene CV, carta, LaTeX y veredicto generados tras la autorización limitada de nombre, primer apellido, correo y teléfono; no ha sido presentada. CAND-2026-007 fue presentada a AGD Center el 2026-07-26. CAND-2026-008 fue presentada a Baleària mediante Indeed el 2026-07-27. CAND-2026-009 fue presentada a LIVVO mediante Indeed el 2026-07-27 y figura como rechazada en Indeed desde la consulta del 2026-07-29. CAND-2026-010 fue presentada a ACCIONA mediante Workday el 2026-07-27. Los estados detallados y los documentos asociados viven en `boveda-entrevista-profesional/busqueda-empleo/seguimiento/seguimiento-candidaturas.md` y en las carpetas de cada candidatura.
