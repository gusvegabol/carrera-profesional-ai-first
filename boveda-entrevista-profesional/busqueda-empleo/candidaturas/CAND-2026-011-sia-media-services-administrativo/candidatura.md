...
- **Oferta en Indeed:** <https://es.indeed.com/viewjob?jk=c8c75571b56fce18>.
- **Empresa:** SIA MEDIA SERVICES.
- **Puesto:** Administrativo/a.
...
- **Evidencias:** HER-01, HER-02, HER-04, HER-07 y GRAN-01.
- **Fortalezas relacionadas:** documentación, informes, automatización
  administrativa, organización del trabajo, facturación histórica y conexión
  con operaciones y vehículos.
- **Condicionantes:** no consta experiencia específica en reservas; la
  equivalencia con dos años en un puesto similar debe revisarse sin inferirla;
  el salario tiene una discrepancia entre el dato mostrado y la descripción.
...
- [x] Oferta revisada y contenido completo conservado.
- [x] Procedencia y fecha registradas.
