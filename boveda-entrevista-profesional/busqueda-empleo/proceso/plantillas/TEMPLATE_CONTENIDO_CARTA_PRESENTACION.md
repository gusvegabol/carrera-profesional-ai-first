...
## 7.1 Conjunto cerrado de afirmaciones autorizadas

Cada afirmación profesional visible debe aparecer aquí antes de pasar a la carta consolidada.
...
- [ ] cada `claim_id` tiene al menos un `A-NNN` existente;
- [ ] cada evidencia está seleccionada por esos `A-NNN`;
- [ ] no hay afirmaciones visibles fuera de este conjunto;
- [ ] la existencia factual sin autorización editorial devuelve `requiere_correccion`.
...
| T19 — Evidencia factual no seleccionada | evidencia en datos-core ausente de los A-NNN | superada / fallida | excluir y regenerar |
| T20 — Trazabilidad factual sin autorización editorial | respaldo factual sin A-NNN | superada / fallida | requiere_correccion |
| T21 — Bloque con A-NNN insuficiente | segunda afirmación fuera del conjunto | superada / fallida | eliminar o escalar |
| T22 — Auditoría factual insuficiente | se valida solo por existencia en datos-core | superada / fallida | exigir A-NNN + fuente |
...
pruebas_v1_1:
  ...
  t13_t22_resultado: superado | requiere_correccion
```
