...
4. Preparar sus cierres sin tocar sesiones `consolidada`, `cerrada` o `archivada`, sin tocar líneas no Job-up y sin escribir todavía nada. Cada cierre debe conservar intacto el cuerpo histórico existente, añadir la hora de cierre de la invocación y dejar una traza mínima de que la sesión se cerró al iniciar un nuevo bloque Job-up.
